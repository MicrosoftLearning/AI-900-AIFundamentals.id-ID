...
Di lab ini, kita akan menggunakan layanan Face di Azure untuk mengidentifikasi item dunia nyata berdasarkan gambar.

-  Buka buku catatan **04 - Analisis Wajah.ipynb** di Visual Studio Code.
